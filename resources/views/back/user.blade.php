...
@section('js')
<!-- <script src="{{ back_asset('js/plugins/jquery.dataTables.min.js') }}"></script>
<script src="{{ back_asset('js/plugins/dataTables.bootstrap4.min.js') }}"></script>
<script src="{{ back_asset('js/pages/data-basic-custom.js') }}"></script> -->
