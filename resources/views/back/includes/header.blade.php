<header class="navbar pcoded-header navbar-expand-lg navbar-light header-blue">
    ...
    <div class="m-header">
        ...
        <a href="#!" class="b-brand">
            ...
            <img src="{{ back_asset('images/logo.png') }}" alt="" class="logo">
                    ...
                    <div class="dropdown-menu dropdown-menu-right notification">
                        ...
                        <ul class="noti-body">
                            ...
                            <li class="notification">
                                <div class="media">
                                    <img class="img-radius" src="{{ back_asset('images/user/avatar-1.jpg') }}" alt="Generic placeholder image">
                            ...
                            <li class="notification">
                                <div class="media">
                                    <img class="img-radius" src="{{ back_asset('images/user/avatar-2.jpg') }}" alt="Generic placeholder image">
                                    <div class="media-body">
