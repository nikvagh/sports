      ...
      <div class="card-header">
        <div class="row">
          ...
          <div class="col-md-6 text-right">
            <a href="{{ url(admin().'/events/'.$event_id.'/eventTeams') }}" class="btn btn-primary"><i class="feather icon-arrow-left"></i> Back</a>
            <a href="{{ url(admin().'/events/'.$event_id.'/eventTeams/'.$event_team_id.'/'.$titles->viewPathPrefix.'/create') }}" class="btn btn-primary"><i class="feather icon-edit-1"></i> Add New {{ $titles->titleSingular }}</a>
          </div>
        </div>
      </div>
      <div class="card-body">
