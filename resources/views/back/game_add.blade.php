  ...
  <div class="col-sm-12">
      ...
      <div class="card">
        ...
        <div class="card-footer">
          <button type="button" name="submit" class="btn btn-primary action_btn save_btn" onclick="store()">Save</button>
          <a class="btn btn-default action_btn" onclick="cancel('{{ url(admin().'/'.$titles->viewPathPrefix) }}')">Cancel</a>
        </div>
      </div>
